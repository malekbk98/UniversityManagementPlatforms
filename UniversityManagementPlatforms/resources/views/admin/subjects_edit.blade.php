        ...
        <form action="{{ route('subjects.update', $subject) }}" method="POST">
            ...
            <div class="form-group">
                ...
                <select class="form-control" name="teacher_id" id="teacher_id">
                    ...
                    <option value="{{$details->id}}" {{ $subject->teacher_id == $details->id ? 'selected' : ''}}>{{$details->user->first_name}}</option>   
                    @endforeach
                </select> 
            </div>
            <div class="form-group">
                <label for="subject_cof">Coeficient Subject</label>
                <input type="number" class="form-control" @error('subject_cof') is-invalide @enderror name="subject_cof" id="subject_cof" value={{$subject->subject_cof}}>
                @error('subject_cof')
            ...
            <div class="form-group">
                ...
                <input type="number" class="form-control" @error('subject_max_abs') is-invalide @enderror name="subject_max_abs" id="subject_max_abs" value={{$subject->subject_max_abs}}>
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" @error('subject_type') is-invalide @enderror name="subject_type" id="subject_type" value={{$subject->subject_type}}>
                @error('subject_type')
